...
class ZB(Base):
    ...
    def __repr__(self):
        return "<ZB ('%s','%s','%s','%s')>" % (self.name.encode('utf8'),self.des.encode('utf8'),self.fid,self.formsid)
...
class Forms(Base):
    ...
    def __repr__(self):
        return "<Forms ('%s','%s','%s','%s','%s','%s')>" % (self.zbid.encode('utf8'),self.pgnr.encode('utf8'),self.fz.encode('utf8'),self.pgbz.encode('utf8').self.pfff.encode('utf8'),self.fid)
...
class FormsClass(Base):
    ...
    def __repr__(self):
        return "<FormClass ('%s','%s')>" % (self.name.encode('utf8'),self.ndid)
...
class Unit(Base):
    ...
    def __repr__(self):
        return "<Unit('%s','%s','%s')>" % (self.name.encode('utf8'),self.pwd.encode('utf8'),self.fid)
...
class School(Base):
    ...
    def __repr__(self):
        return "<School('%s','%s','%s','%s','%s','%s','%s')>" % (self.school_dm.encode('utf8'),self.school_names.encode('utf8'),self.townname.encode('utf8'),self.school_xd.encode('utf8'),self.school_type.encode('utf8'),self.school_nature.encode('utf8'),self.fid)
